      ...
      <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">🌟 What users say</h2>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 items-center text-center mt-5">
            <div className="p-6 bg-white rounded-lg shadow-md">
                <p className="text-gray-700">"HobbyHub has transformed my free time! I've met amazing people and learned so much."</p>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
                <p className="text-gray-700">"The community is so supportive. I love sharing my photography passion with others."</p>
                ...
                <h4 className="mt-4 font-semibold">- Mike D.</h4>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-md text-center">
                <p className="text-gray-700">"I never knew how much I needed a hobby group until I joined HobbyHub. It's been a game-changer!"</p>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
                <p className="text-gray-700">"HobbyHub helped me discover my love for painting. The workshops are fantastic!"</p>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
                <p className="text-gray-700">"I joined a hiking group through HobbyHub and now I have friends to explore the outdoors with!"</p>
            ...
            <div className="p-6 bg-white rounded-lg shadow-md">
                <p className="text-gray-700">"HobbyHub is more than just a platform; it's a community that inspires and motivates me every day."</p>
